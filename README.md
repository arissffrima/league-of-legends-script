<p align="center">
  <b>league-of-legends-script</b>
</p>

<p align="center">
  <sub>League of Legends</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>LolScript</code> &nbsp;·&nbsp; <code>lolscript</code>
</p>
...
LoL scripting base — orbwalker hook, skillshot evade, ward timer overlay.

Script forums index league-of-legends-script repos first.
...
```bash
dotnet restore league-of-legends-script.slnx
dotnet build league-of-legends-script.slnx -c Release
dotnet test league-of-legends-script.slnx -c Release
```
